...
export default function TripScreen() {
  ...
  const handleShare = async (title: string) => {
    try {
      await Share.share({ message: `Check out ${title} on EcoTravel!` });
    } catch (error) {
      console.log(error);
    }
  };
        ...
        {TRIPS_DATA.map((item) => (
          <View key={item.id} style={styles.card}>
              ...
              <View style={styles.cardInfo}>
                <View style={styles.titleRow}>
                  ...
                  <View style={[styles.badge, { backgroundColor: item.badgeColor }]}>
                    <Ionicons name="shield-checkmark" size={10} color={item.badgeTextColor} style={{ marginRight: 2 }} />
            ...
            <View style={styles.actionRow}>
              ...
              >
                <Ionicons name="navigate-outline" size={16} color="#0E4D3C" />
              ...
              >
                <Ionicons name="call-outline" size={16} color="#0E4D3C" />
              ...
              >
                <Ionicons name="share-social-outline" size={16} color="#0E4D3C" />
...
const styles = StyleSheet.create({
  ...
  actionText: { fontSize: 10, color: '#0E4D3C', marginTop: 2, fontWeight: '600' },
